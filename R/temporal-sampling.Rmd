...
output <- ut(y=exp(ar1), sample_size = c(20:50), threshold_error = c(2:10), each = 100, type="mean")
names(output)
...
temporary <- ut(y=exp(ar1), sample_size = c(10:50), threshold_error = c(1:10), each = 1, type="mean")
...
ggplot(out_convergence_cptmean, aes(sample_size,number_sample_added)) + geom_point(alpha=.3) + ylim(0,25)
