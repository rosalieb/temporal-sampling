...
**Note for next time: write function to compute the tolerance to error against sample size**
...
```{r, cache = T}
output <- ut(y=exp(ar1), sample_size = c(20:50), threshold_error = c(2:10))
names(output)
...
outsumm$more80 <- ifelse(outsumm$value>=7,1,0)
