...
pacman::p_load(patchwork, stickylabeller, ggplot2, dplyr, wesanderson, reshape, cowplot, vegan, ecp)
```
...
ERW and RB conceived the ideas and designed methodology; RB collected the data; ERW designed the simulations; RB wrote the R code that simulates the three sampling approaches; ERW and RB analysed the data; Both authors contributed critically to the drafts and gave final approval for publication
...
#mypal <-  c("#4C4F54", "#D57A5D", "#AE5654", "#D18437", "#9EC6DD")
