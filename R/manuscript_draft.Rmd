...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap='Iterative sampling and impact on ordination.  \\label{fig:case_study_iterative_sampling}'}
...
vrsub <- sample_iterative(vr, n=5, n2=5, input_vector = F, xcol = 1, DCA_axis = 1, messages = F)
