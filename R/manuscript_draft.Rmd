...
Note that the number of sample needed varies depending on the characteristics of the time series. For perspective, the autocorrelation at lag-1 in the first DCA component we used in the case study example is `r round(ar_vr$acf[2],3)`, the variance is `r round(sd_vr,3)`, and the normalized amplitude of the shift was `r round(shift_vr,3)`.
