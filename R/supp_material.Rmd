...
\begin{center}
\textbf{\Large Supplementary Material for: Title here}
\vspace{7 mm}
...
Data and code for all the figures can be found at (https://github.com/rosalieb/temporal-sampling.git). All the analyses were run in R.
